...
echo set PORT=7124 >> "%TEMP%\pavane-api.bat"
...
echo npx next dev -p 7123 >> "%TEMP%\pavane-web.bat"

echo [1/2] Iniciando API em http://localhost:7124 ...
start "Pavane API" /min "%TEMP%\pavane-api.bat"

timeout /t 5 /nobreak >nul

echo [2/2] Iniciando UI em http://localhost:7123 ...
start "Pavane UI" /min "%TEMP%\pavane-web.bat"

timeout /t 6 /nobreak >nul

echo.
echo  Abrindo http://localhost:7123 ...
start "" "http://localhost:7123"

echo.
echo  ==========================================
echo   Pavane esta rodando!
echo   API : http://localhost:7124
echo   UI  : http://localhost:7123
echo  ==========================================
echo.
