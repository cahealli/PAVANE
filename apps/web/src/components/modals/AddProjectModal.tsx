  ...
  return (
    <Modal open={open} onClose={onClose} title="Add Project">
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <div>
          <label className="text-xs text-pavane-text-muted mb-1 block">Project Name</label>
          <input
            value={name}
        ...
        <div>
          <label className="text-xs text-pavane-text-muted mb-1 block">Repository Path</label>
          <input
            value={repoPath}
          ...
          />
          <p className="text-[10px] text-pavane-text-muted mt-1">Absolute path to the git repository</p>
        </div>
        <div>
          <label className="text-xs text-pavane-text-muted mb-1 block">Default Branch</label>
          <input
            value={branch}
